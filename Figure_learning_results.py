...
plt.figure()
plt.xticks(range(-4,5,2),fontsize=25)
plt.yticks(fontsize=25)
plt.scatter(w11,w12,c = 'blue',marker = 'o',s=120)  
plt.scatter(w21,w22,c = 'red',marker = '*',s=200) 
plt.xlabel(r'$w_{1}^{(1)}, w_{2}^{(1)}$',fontsize=30)
plt.ylabel(r'$w_{1}^{(2)}, w_{2}^{(2)}$',fontsize=30)
